  ...
  return (
    <section id="hero" className="relative w-full h-screen min-h-[600px] flex items-center overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 md:px-10 w-full">
        ...
        >
          ...
          >
            ...
            <span className="font-condensed text-xs tracking-[0.2em] uppercase text-[#00B4FF]">Detalhamento Premium · Itajaí</span>
          </div>

          {/* Headline */}
          <h1 className="font-display text-6xl md:text-8xl lg:text-[110px] leading-none text-white mb-4">
            ONDE O<br />
            <span style={{ color: '#00B4FF', textShadow: '0 0 40px rgba(0,180,255,0.4)' }}>DETALHE</span><br />
            DEFINE TUDO
          </h1>

          {/* Subtitle */}
          <p className="text-[#8898B3] text-base md:text-lg font-light max-w-xl mb-10 leading-relaxed" style={{ transitionDelay: '200ms' }}>
          ...
          <div className="flex gap-8 mt-14">
            {[
              ...
              <div key={s.l}>
                <div className="font-display text-2xl md:text-3xl text-white">{s.n}</div>
                <div className="font-condensed text-xs tracking-widest uppercase text-[#8898B3]">{s.l}</div>
              </div>
            ))}
          </div>
        </div>
      ...
      <div className="absolute bottom-8 left-1/2 -translate-x-1/2 flex flex-col items-center gap-2 opacity-50">
        <span className="font-condensed text-[10px] tracking-[0.3em] uppercase text-[#8898B3]">Scroll</span>
